...
class _CamerMarketScreenState extends State<CamerMarketScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: authProvider.isAnonymous ? _AnonBanner() : null,
      body: Column(
        children: [
          if (commerceProvider.hasCachedData) const _OfflineBanner(),
          Expanded(
            child: IndexedStack(
...
class _MapTabState extends State<_MapTab> {
  ...
  Future<void> _preloadMapIcons() async {
    try {
      ...
      debugPrint('[MapTab] preloadIcons ignoré : $e');
    }
  }
  ...
  Future<void> _startLocationStream() async {
    ...
    _locationSubscription =
        _mapService.startLocationStream().listen((position) {
  ...
  List<String> get _mapCategories {
    final cats =
        _commerceProvider.commerces.map((c) => c.categorie).toSet().toList();
    cats.sort();
    return cats;
  }
          ...
          child: Column(
            ...
            children: [
                  ...
                  if (!isOwner && commerce.id != null)
                    Align(
                      ...
                      child: StreamBuilder<bool>(
                        stream: FavoriteService.isFavorite(commerce.id!),
                        builder: (_, snap) {
              ...
              _InfoRow(
                  ...
                  label: 'Position',
                  value:
                      '${commerce.position.latitude.toStringAsFixed(4)}, '
              ...
              _InfoRow(
                  ...
                  label: 'Enregistré le',
                  value:
                      '${commerce.createdAt.day}/${commerce.createdAt.month}/${commerce.createdAt.year}'),
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // ── Boutons droite : style carte + Ma position ──
        Positioned(
          bottom: 230,
          right: 16,
          child: Column(
...
class _HomeTab extends StatefulWidget {
  ...
  const _HomeTab({required this.onViewMap});
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        slivers: [
                  ...
                  : _homeProducts.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final commerce = commerceProvider.commerces
                                .where((c) => c.id == p['commerce_id'])
                                .firstOrNull;
                            final rawUrls = p['image_urls'];
                            final String? firstImage =
                                (rawUrls is List && rawUrls.isNotEmpty)
          ...
          else if (commerceProvider.commerces.isEmpty)
            SliverToBoxAdapter(
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                (context, index) => Padding(
                  ...
                  child: _MarketCard(
                      commerce: commerceProvider.commerces[index]),
                ),
                childCount: commerceProvider.commerces.length,
              ),
            ),
...
class _ProductHorizontalCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final accentLight = isService
        ? AppColors.lightForType(CommerceType.etablissement, dark: isDark)
        : AppColors.lightForType(CommerceType.boutique, dark: isDark);
    final typeLabel = isService ? 'Service' : 'Produit';
    final typeIcon =
        isService ? Icons.design_services : Icons.inventory_2_outlined;
                ...
                children: [
                  firstImage != null
                      ...
                      : Container(
                          ...
                          child: Center(
                            child: Icon(typeIcon,
                                color: accent.withValues(alpha: 0.5), size: 32),
                          ),
                        ),
                  Positioned(
                    top: 8,
